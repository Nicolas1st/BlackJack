// let div = document.querySelect('some-class');

// div.addEventListerer('click', func);
...
function hit() {
  ...
  newCard.src = `/static/images/${cardFiles[newCardNum]}`;
  console.log(cardFiles[newCardNum])
